/*
inmutable
Map nos genera una copia donde retorna una arreglo de la misma longitud del arreglo iterado, con las modificaciones realizada segun la condicion
*/
const arrayData = [
    {
...
const arrayModifierd = arrayData.map((i) => {
    if(i.age >= 30 && i.age < 40) i["mote"] = "30Ton";
    return i
})

console.log(arrayModifierd)